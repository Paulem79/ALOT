...
public class WaterCollector extends MushroomCustomBlock {
    public WaterCollector(ALOT main) {
        super(main);
    }
    ...
    public @NotNull ItemStack item() {
        ...
        im.setLocalizedName("water_collector");
    ...
    public NamespacedKey itemKey() {
        return new NamespacedKey(main, "water_collector");
    }

    @Override
    public @NotNull Set<BlockFace> faces() {
        return Set.of(BlockFace.DOWN);
    }
}
